...
plt.title('Gender Studies NLTK Compound Score Distribution')
plt.savefig("graphs/gen_nltk_com.svg")

plt.clf()
tweets['nltk_pos'].hist(color='k', alpha=0.5, bins=50)
plt.title('Gender Studies NLTK Positive Score Distribution')
plt.savefig("graphs/gen_nltk_pos.svg")

plt.clf()
tweets['nltk_neg'].hist(color='k', alpha=0.5, bins=50)
plt.title('Gender Studies NLTK Negative Score Distribution')
plt.savefig("graphs/gen_nltk_neg.svg")

plt.clf()
tweets['nltk_neu'].hist(color='k', alpha=0.5, bins=50)
plt.title('Gender Studies NLTK Neutral Score Distribution')
plt.savefig("graphs/gen_nltk_neu.svg")

plt.clf()
tweets['ss_com'].hist(color='k', alpha=0.5, bins=50)
plt.title('Gender Studies SentiStrength Compound Score Distribution')
plt.savefig("graphs/gen_ss_com.svg")

plt.clf()
tweets['ss_pos'].hist(color='k', alpha=0.5, bins=50)
plt.title('Gender Studies SentiStrength Positive Score Distribution')
plt.savefig("graphs/gen_ss_pos.svg")

plt.clf()
tweets['ss_neg'].hist(color='k', alpha=0.5, bins=50)
plt.title('Gender Studies SentiStrength Negative Score Distribution')
plt.savefig("graphs/gen_ss_neg.svg")
