...
tweets = pd.read_json('./cleanData/tweets_cult_clean_notitles.json')
...
plt.title('Cultural Studies NLTK Compound Score Distribution')
plt.savefig("graphs/cult_nltk_com.svg")

plt.clf()
tweets['nltk_pos'].hist(color='k', alpha=0.5, bins=50)
plt.title('Cultural Studies NLTK Positive Score Distribution')
plt.savefig("graphs/cult_nltk_pos.svg")

plt.clf()
tweets['nltk_neg'].hist(color='k', alpha=0.5, bins=50)
plt.title('Cultural Studies NLTK Negative Score Distribution')
plt.savefig("graphs/cult_nltk_neg.svg")

plt.clf()
tweets['nltk_neu'].hist(color='k', alpha=0.5, bins=50)
plt.title('Cultural Studies NLTK Neutral Score Distribution')
...
plt.title('Cultural Studies SentiStrength Positive Score Distribution')
plt.savefig("graphs/cult_ss_pos.svg")

plt.clf()
tweets['ss_neg'].hist(color='k', alpha=0.5, bins=50)
plt.title('Cultural Studies SentiStrength Negative Score Distribution')
plt.savefig("graphs/cult_ss_neg.svg")
